const About = () => {
  return (
    <div className="pb-10 grid grid-cols-1 sm:grid-cols-2 pr-2">
      <div className="">
        <div className="flex flex-row text-start ml-5 pt-[16px] lg:pl-32 lg:pr-32 font-bold text-3xl leading-normal lg:text-6xl lg:leading-normal bg-white stroke-b-1px lg:stroke-b-2px text-white">
          About
          <p className="pl-3 no-shadow text-black font-medium pb-2"> Us</p>
        </div>
        <p className="text-lg leading-8 text-gray-600 ml-5 lg:pl-32">
